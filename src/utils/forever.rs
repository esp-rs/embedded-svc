...
/// context.
///
/// Copied over from Embassy: https://github.com/embassy-rs/embassy/blob/master/embassy/src/util/forever.rs
/// Note: IF a global mutable variable is desired, use a mutex instead.
///
/// ```
